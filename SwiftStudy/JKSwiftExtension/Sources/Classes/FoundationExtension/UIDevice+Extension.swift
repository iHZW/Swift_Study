...
public extension JKPOP where Base: UIDevice {
    ...
    static func screenType() -> UIDeviceScreenType {
        ...
        if modelName == "iPhone 5" || modelName == "iPhone 5c" || modelName == "iPhone 5s" || modelName == "iPhone SE" {
            ...
            return UIDeviceScreenType.IPHONE_12_PRO_MAX
            ...
            return UIDeviceScreenType.IPHONE_13_PRO_MAX
            ...
            return UIDeviceScreenType.IPHONE_14_PRO_MAX
        }
        return UIDeviceScreenType.IPHONE_6
    }
    ...
    static func isIphoneXScreen() -> Bool {
        if Base.jk.screenType() == .IPHONE_X
            || Base.jk.screenType() == .IPHONE_XS
            || Base.jk.screenType() == .IPHONE_XR
            || Base.jk.screenType() == .IPHONE_XS_Max
            || Base.jk.screenType() == .IPHONE_11
            || Base.jk.screenType() == .IPHONE_11_PRO
            || Base.jk.screenType() == .IPHONE_11_PRO_MAX
            || Base.jk.screenType() == .IPHONE_12
            || Base.jk.screenType() == .IPHONE_12_PRO
            || Base.jk.screenType() == .IPHONE_12_PRO_MAX
            || Base.jk.screenType() == .IPHONE_13
            || Base.jk.screenType() == .IPHONE_13_PRO
            || Base.jk.screenType() == .IPHONE_13_PRO_MAX
            || Base.jk.screenType() == .IPHONE_14
            || Base.jk.screenType() == .IPHONE_14_PRO
            || Base.jk.screenType() == .IPHONE_14_PRO_MAX {
            return true
        }
        return false
    }
    ...
    static func isIphoneXSScreen() -> Bool {
        if Base.jk.screenType() == .IPHONE_XS
            || Base.jk.screenType() == .IPHONE_XR
            || Base.jk.screenType() == .IPHONE_XS_Max {
            return true
        }
